...
@section('title', 'Dashboard | Konten Pengguna | Tentang Kami | Ubah Content | E-Commerce')

@section('content')
<div class="px-4 py-12 mx-auto max-w-7xl sm:px-6 lg:px-8">
  <div class="pb-5 border-b border-gray-200">
    <h3 class="text-3xl font-bold leading-6 text-gray-900">Kelola Content Tentang Kami</h3>
    <p class="max-w-4xl mt-3 text-sm text-gray-500">Halaman ini memungkinkan Anda untuk mengatur dan memperbarui content Tentang Kami dengan mudah.</p>
  </div>
</div>
<div class="grid grid-cols-1 px-4 pb-12 mx-auto border-b sm:px-6 lg:px-8 gap-x-8 gap-y-10 border-gray-900/10 md:grid-cols-3 max-w-7xl">
  <div>
      <h2 class="text-base font-semibold leading-7 text-gray-900">Manajemen Content Tentang Kami</h2>
      <p class="mt-1 text-sm leading-6 text-gray-600">Atur dan kelola content Tentang Kami sesuai kebutuhan Anda melalui fitur yang tersedia di sini.</p>                
  </div>

  <form action="{{ route('dashboard.about.update.content') }}" method="POST" enctype="multipart/form-data" class="w-full md:col-span-2">
      @csrf
      @method('PUT')
